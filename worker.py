...
# --- WebSocket endpoint and addresses ---
...
def listen_for_events():
    ...
    # ✅ Correct Web3 v7 syntax: from_block
    event_filter = contract.events.PanelEventAdded.create_filter(from_block="latest")
    ...
    while True:
        try:
            for event in event_filter.get_new_entries():
                ...
                print(
                    f"🔹 New Event → {panel_id} | {event_type} | {fault_type} | "
